...
SWEP.Primary.Sound = {"vj_base/weapons/smg1/single1.wav","vj_base/weapons/smg1/single2.wav"}
SWEP.Primary.DistantSound = {"vj_base/weapons/mp40/single.wav"}
SWEP.PrimaryEffects_MuzzleAttachment = nil
